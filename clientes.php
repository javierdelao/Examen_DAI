...
<div class="container" id="container2">
  ...
  <form class="form-horizontal" action="/action_page.php">
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="rut_cliente" placeholder="Ingrese rut" name="rut_cliente">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2">Nombre completo:</label>
      <div class="col-sm-10">          
          <input type="text" class="form-control" id="nombre_cliente" placeholder="Ingrese nombre completo" name="nombre_cliente">
      </div>
    </div>
      <div class="form-group">
      <label class="control-label col-sm-2" for="rut">Fecha inscripción:</label>
      <div class="col-sm-10">
    ...
    <div class="form-group">
    <label class="control-label col-sm-2" for="rut">Tipo persona:</label>    
      <input type="radio" name="optradio" id="natural">Natural
   
      <input type="radio" name="optradio" id="juridica">Jurídica
 
</div>
      
        <div class="form-group">
      <label class="control-label col-sm-2" for="rut">Dirección:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="direccion_cliente" placeholder="Ingrese dirección" name="direccion_cliente">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2">Teléfono:</label>
      <div class="col-sm-10">          
          <input type="text" class="form-control" id="telefono_cliente" placeholder="Ingrese teléfono" name="telefono_cliente">
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-6 paddingtop-bottom">
        <h6 class="heading7">REGISTRO REDES</h6>
        <div class="post">
          <p>facebook crack the movie advertisment code:what it means for you <span>Agosto 3,2017</span></p>
          <p>facebook crack the movie advertisment code:what it means for you <span>Agosto 3,2017</span></p>
          <p>facebook crack the movie advertisment code:what it means for you <span>Agosto 3,2017</span></p>
        </div>
      </div>
